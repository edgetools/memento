...
- In TDD, you should write tests based purely on the spec and requirements, almost naively ignoring what exists in the implementation.

- If your tests require methods that don't exist yet, that's exactly right—the implementation agent will create them.
